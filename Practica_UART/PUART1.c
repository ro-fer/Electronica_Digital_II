...
Ejercicio 1:
Implementar un código C para enviar una cadena de caracteres a través de la USART1 cada un segundo utilizando polling. Para temporizar los envíos de las cadenas utilizar el systick.
*/
#include "map.h"
