...
Ejercicio 4 :  Implementar un código C de bajo nivel que lea el estado de un pin en particular haciendo polling y que muestre el resultado en un led. El estado del pin debe manejarse utilizando un cable conectado a 3.3 V oamasa.
