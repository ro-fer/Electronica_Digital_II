...
Ejercicio 3 :  Agregar un led externo a la placa e implementar un código C de bajo nivel que lo encienda y apague, junto con el existente en la placa, siguiendo algún patrón.
*/
...

{
    ...
    while(1){
        ...
        GPIOC_ODR ^= (1<<15); // Cambio el estado del pin 15
...
// Función para producir un retardo
void delay(void)
{
    volatile int i, t; 
