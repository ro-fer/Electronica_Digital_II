...
Ejercicio 2:
Implementar un código C de bajo nivel (sin utilizar las funciones de biblioteca) que genere una salida cuadra por uno de los GPIO utilizando DMA. Verificar utilizando un osciloscopio. 
*/
#include "map.h"
